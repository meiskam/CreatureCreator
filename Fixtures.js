...
class Fixture {
    ...
    show(body) {
        ...
        //this is used to help identify when creatures are straining (essentially when they are fuckin with the physics engine)
...
function doConvexPolygonsOverlapALot2(polygon1, polygon2) {
    return doConvexPolygonsOverlap(shrinkPolygon(polygon1, 1.5), shrinkPolygon(polygon2, 1.5));
}
